...
public class AccountTest {
  ...
  @Test
    public void valueNextMonthChekingTest() {
        checkingAccount = new Account("003", "Checking", 100.0f);
        checkingAccount.setMonthlyFee(0.0f);
        checkingAccount.setMonthlyInterestRate(0.0f);
